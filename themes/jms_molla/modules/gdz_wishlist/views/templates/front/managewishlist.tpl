			...
			<li id="wlp_{$product.id_product}_{$product.id_product_attribute}" class="clearfix col-6 col-md-4 col-lg-3 address {if $smarty.foreach.i.index % 2}alternate_{/if}item">
				...
				<div class="clearfix">
					...
					<div class="product_infos">
						...
						{/if}
							{l s='Quantity' d='Shop.Theme'}:<input type="text" id="quantity_{$product.id_product}_{$product.id_product_attribute}" value="{$product.quantity|intval}" class="form-control" size="3"  />

 ...
 *}
<div class="product-miniature js-product-miniature productbox-14" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
					...
					{if $product.show_price}
						<div class="content_price">
							...
							{if $product.has_discount}
								...
								<span class="old price">{if $product.has_discount}{l s='Was' d='Shop.Theme.Actions'}{/if} {$product.regular_price}</span>
							{/if}

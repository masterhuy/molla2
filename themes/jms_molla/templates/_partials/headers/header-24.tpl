            ...
            <div class="row align-items-center no-margin">
                ...
                <div class="layout-column col header-right justify-content-end">
                    <ul class="top-menu d-flex align-items-center mb-0">
                        <li>
                            <a class="color-white" href="{l s='tel:0123 456 789' d='Shop.jmstheme'}"><i class="icon-phone"></i>{l s='Call: +0123 456 789' d='Shop.jmstheme'}</a>
                        </li>
                        {if ($gdzSetting.wishlist == 1)}
                        <li>
                            <a class="color-white" href="index.php?fc=module&module=gdz_wishlist&controller=mywishlist">
                                <i class="icon-heart-o"></i>{l s='My Wishlist' d='Shop.jmstheme'}
                            </a>
                        </li>
                        {/if}
                        <li>

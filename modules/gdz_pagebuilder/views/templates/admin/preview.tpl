...
<div id="pb-right-menu" style="display:none;">
    <ul>
    <li class="edit-row"><a href="#"><i class="fa fa-edit"></i>{l s='Edit Row' mod='gdz_pagebuilder'}</a></li>
    <li class="duplicate-row seperator"><a href="#"><i class="fa fa-copy"></i>{l s='Duplicate' mod='gdz_pagebuilder'}</a></li>
    <li class="copy-style-row"><a href="#"><i class="fa fa fa-magic"></i>{l s='Copy Style' mod='gdz_pagebuilder'}</a></li>
    <li class="paste-style-row"><a href="#"><i class="fa fa-magic"></i>{l s='Paste Style' mod='gdz_pagebuilder'}</a></li>
    <li class="reset-style-row seperator"><a href="#"><i class="fa fa-magic"></i>{l s='Reset Style' mod='gdz_pagebuilder'}</a></li>
    <li class="save-template-row" data-dialog="template-library" data-form="save"><a href="#"><i class="fa fa-floppy-o"></i>{l s='Save as Template' mod='gdz_pagebuilder'}</a></li>
    <li class="export-row seperator"><a href="#"><i class="fa fa-arrow-circle-o-down"></i>{l s='Export to File' mod='gdz_pagebuilder'}</a></li>
    <li class="delete-row"><a href="#"><i class="fa fa-trash-o"></i>{l s='Delete' mod='gdz_pagebuilder'}</a></li>
    </ul>
</div>

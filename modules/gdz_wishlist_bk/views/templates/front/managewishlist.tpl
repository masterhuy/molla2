...
{if $products}
	...
	<div class="wishlist-container">
		<a href="#" class="button_account hide-wishlist" onclick="WishlistVisibility('wishlist-container', 'Wishlist'); return false;" title="{l s='Close this wishlist' d='Shop.Theme'}" rel="nofollow"><i class="fa fa-close"></i>{l s='Close this wishlist' d='Shop.Theme'}</a>

		<div class="wishlist-url">{l s='Permalink' d='Shop.Theme'}: <input type="text" value="{$link->getModuleLink('gdz_wishlist', 'view', ['token' => $token_wish])|escape:'html':'UTF-8'}" class="form-control" readonly="readonly" /></div>
		<div class="wishlist-tools">
			<div id="showSendWishlist">
				<a href="#" class="button_account exclusive" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" title="{l s='Send this wishlist' d='Shop.Theme'}"><i class="fa fa-send-o"></i>&nbsp;&nbsp;{l s='Send this wishlist' d='Shop.Theme'}</a>
			</div>
			<ul class="clearfix display_list">
				<li>
					...
					<a href="#" id="showBoughtProducts" class="button_account"  onclick="WishlistVisibility('wlp_bought', 'BoughtProducts'); return false;" title="{l s='Show products' d='Shop.Theme'}" style="display:none;">{l s='Show products' d='Shop.Theme'}</a>
				</li>
			...
			<li id="wlp_{$product.id_product}_{$product.id_product_attribute}" class="clearfix address {if $smarty.foreach.i.index % 2}alternate_{/if}item">
				...
				<div class="clearfix">
					...
					<div class="product_infos">
						...
						{/if}
							<br />{l s='Quantity' d='Shop.Theme'}:<input type="text" id="quantity_{$product.id_product}_{$product.id_product_attribute}" value="{$product.quantity|intval}" class="form-control" size="3"  />
							<br /><br />
